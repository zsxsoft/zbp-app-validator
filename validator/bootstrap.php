...
use Zsxsoft\AppValidator\Commands\PHPCompatibility;
...
use Zsxsoft\AppValidator\Commands\EnableApp;
...
$application->add(new PHPCompatibility());
$application->run();
